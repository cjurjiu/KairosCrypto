 ...
 */
@Entity(tableName = DbCryptoCoinDetails.COIN_DETAILS_TABLE_NAME)
data class DbCryptoCoinDetails(@PrimaryKey @ColumnInfo(name = "id") val id: String,
    ...
    companion object {
        const val COIN_DETAILS_TABLE_NAME: String = "coin_details"
    }
}